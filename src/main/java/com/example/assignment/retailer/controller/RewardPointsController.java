...
public class RewardPointsController {
	...
	/*
	 * In this Get API we are calling specific customer and there calculated points
	 * on Monthly basis for the name of argument we need to pass then we can get
	 * info about customer
	 * 
	 */
	...
	/*
	 * In This Get API we are fetching all customer information about customer with
	 * calculated rewards points earned from retailer and it will fetch all customer
	 * with his month basis calculated reward points
	 */
